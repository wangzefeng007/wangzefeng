...
<!--{else}-->
	<div class="box xg1 n5-dnbts">
	<!--{if $special == '2'}-->
	{lang send_special_trade_error}
    <!--{elseif $special == '4'}-->
	{lang send_special_activity_error}
	<!--{elseif $isfirstpost && $sortid}-->
	{lang threadsort_error} <p><span id="n5-show"></span> <a href="{$_G['setting']['mobile']['nomobileurl']}">跳转至 {lang nomobiletype}</a></p>
    <!--{/if}-->
    </div>
<!--{/if}-->
...
function refer(){ 
if(t==0){ 
location="{$_G['setting']['mobile']['nomobileurl']}"; 
} 
document.getElementById('n5-show').innerHTML=""+t+"秒后";
t--;
} 
</script> 
