	...
	<div class="mn">
		...
		<!--{if $attentionthread}-->
			<!--{loop $attentionthread $groupid $threads}-->
				<div class="bm tl">
					<div class="th">
						<table cellspacing="0" cellpadding="0" class="th" style="padding:0">
							<tr>
								<td colspan="2" style="height:15px"><a href="forum.php?mod=group&fid=$groupid" target="_blank" class="xw1">{$usergroups['groups'][$groupid]}</a></td>
								<td class="num" style="height:15px">{lang replies}</td>
								<td class="by" style="height:15px">{lang last_post}</td>
							</tr>
						</table>
					</div>
					<div class="bm_c" style="padding: 0 13px 10px 10px;">
		...
		<div class="bm tl">
			<div class="th">
				<table cellpadding="0" cellspacing="0" class="th" style="padding:0">
					<tr>
