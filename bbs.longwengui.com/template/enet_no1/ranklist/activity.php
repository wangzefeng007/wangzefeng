		...
		<div class="bm bw0">
			...
			<!--{if $activitylist}-->
				...
				<!--{loop $activitylist $activity}-->
					<tr>
						<td width="35" style="padding-left: 10px;"><!--{if $activity['rank'] <= 3}--><img src="{IMGDIR}/rank_$activity['rank'].gif" alt="$activity['rank']" /><!--{else}-->$activity['rank']<!--{/if}--></td>
						<td class="type"><!--{if $activity['aid']}--><img src="$activity['attachurl']" width="80" alt="" /><!--{else}--><img src="{IMGDIR}/nophotosmall.gif" alt="nophoto" width="80" height="80" /><!--{/if}--></td>
						<td>
