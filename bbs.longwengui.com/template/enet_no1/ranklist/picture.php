		...
		<div class="bm bw0">
			...
			<!--{if $picturelist}-->
				...
				<!--{loop $picturelist $picture}-->
					<li class="d">
						<div class="c">
							<!--{if $picture['rank'] <= 3}--><img src="{IMGDIR}/rank_$picture['rank'].gif" alt="$picture['rank']" class="picrank" style="width: 14px;height: 13px;"/><!--{/if}-->
						...
						<!--{else}--><p class="ptm" style="padding-top:3px !important">$clicks[$_GET[view]][name] $picture['click'.$_GET[view]]</p><!--{/if}-->
