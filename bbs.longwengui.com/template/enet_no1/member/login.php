				...
				<div class="rfm">
					<table>
						<tr>
							...
							<td><select id="loginquestionid_$loginhash" size="1" name="questionid"{if !$questionexist} onchange="if($('loginquestionid_$loginhash').value > 0) {$('loginanswer_row_$loginhash').style.display='';} else {$('loginanswer_row_$loginhash').style.display='none';}"<!--{/if}-->>
				...
				<div class="rfm {if !empty($_GET['infloat'])} bw0{/if}">
					<table>
						<tr>
							...
							<td style="padding-left:100px;"><a href="javascript:;" onclick="display('layer_login_$loginhash');display('layer_lostpw_$loginhash');" title="{lang getpassword}" style="line-height: 29px;">{lang getpassword}</a></td>
						</tr>
					</table>
				</div>
				...
				<div class="rfm mbw bw0">
					<table width="100%">
						<tr>
							<th>&nbsp;</th>
							<td style="width:75px">
								<button class="pn pnc" type="submit" name="loginsubmit" value="true" tabindex="1" style="width:68px"><strong>{lang login}</strong></button>
							</td>
							<td>
							<a href="member.php?mod={$_G[setting][regname]}" class="pn rig" style="width: 130px;height: 25px !Important;display:block"><strong style="line-height:26px">$_G['setting']['reglinkname']</strong></a></td>
							<td>
			...
			<div class="c cl">
				...
				<div class="rfm mbw bw0">
					<table>
						<tr>
							<th></th>
							<td><button class="pn pnc" type="submit" name="lostpwsubmit" value="true" tabindex="100" style="width: 234px;"><span>{lang submit}</span></button></td>
						</tr>
					</table>
				</div>
			</div>
