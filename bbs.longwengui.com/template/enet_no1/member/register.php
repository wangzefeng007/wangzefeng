						...
						<td>
							<span id="reginfo_a_btn">
								<!--{if $_GET[action] != 'activation'}--><em>&nbsp;</em><!--{/if}-->
									<button class="pn pnc" id="registerformsubmit" type="submit" name="regsubmit" value="true" tabindex="1" style="width: 220px;"><strong><!--{if $_GET[action] == 'activation'}-->{lang activation}<!--{else}-->{lang submit}<!--{/if}--></strong></button>
								<!--{if $bbrules}-->
