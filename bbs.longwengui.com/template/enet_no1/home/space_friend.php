...
<div id="ct" class="ct7_a wp cl">
	...
	<div class="mn">
		...
		<div class="bm bw0">
			<!--{if $space[self]}-->
				<h1 class="mt"><img alt="friend" src="{STATICURL}image/feed/friend.gif" class="vm" /> {lang friend_list}</h1>
				<ul class="tb cl">
							...
							<div class="bm mtm">
								...
								<div class="bm_c">
									<form method="get" autocomplete="off" action="home.php" class="pns">
										...
										<input type="text" name="searchkey" class="px vm" size="20" value="" onclick="if(this.value=='{lang search_friend}')this.value='';" style="width:230px"/>&nbsp;<button type="submit" class="pn vm" style="margin-top:10px;margin-left:80px"><em>{lang search}</em></button>
									</form>
								</div>
							</div>
