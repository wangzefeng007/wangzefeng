...
<style>
.pml dl{padding-left:10px}
.xld .m{margin-right:10px}
.pm_c .o{margin: 5px 0 0 -20px}
.pm_c {padding-left:85px}
.pm_o{width:auto}
			...
			<!--{if $_GET['subop'] == 'view'}-->
				...
				<!--{if !$type && $plid}-->
					<div class="tbmu pml pm_op_r cl">
						<div class="y pm_o">
							<a href="javascript:;" id="pm_operation" class="o" onmouseover="showMenu({'ctrlid':this.id, 'pos':'34'})" style="padding:0">{lang menu}</a>
				...
				<!--{if ($touid || $plid) && $list}-->
					...
					<div id="pm_ul_post" class="xld xlda pml">
						<dl class="cl">
							...
							<dd class="ptm" style="margin-left:70px">
