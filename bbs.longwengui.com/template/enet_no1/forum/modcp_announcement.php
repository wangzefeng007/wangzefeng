				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="35%" class="hasd">
							<input type="text" onclick="showcalendar(event, this, false)" id="starttime" name="starttime" autocomplete="off" value="$announce[starttime]" class="px" tabindex="1" />
							<a href="javascript:;" class="dpbtn" onclick="showselect(this, 'starttime', 1)">^</a>
						</td>
						<th width="15%">{lang endtime}:</th>
						<td width="35%" class="hasd cl">
							<input type="text" onclick="showcalendar(event, this, false)" id="endtime" name="endtime" autocomplete="off" value="$announce[endtime]" class="px" tabindex="1" />
