...
<form action="forum.php?mod=collection&action=edit&op=invite&ctid={$ctid}" method="post">
	<div class="c">
		...
		.un_selector span{float:left;margin:1px 2px 1px 0;width:100px;height:19px;line-height:19px;background:#F7F6ED url(static/image/common/un_selector.png) no-repeat 0 0;color:#59cbc7;overflow:hidden;}
		...
		.un_selector .x:hover{background-position:100% -38px;}a.appendmb,a.appendmb span{height:25px;line-height:25px !important;}.pmfrndl{position:absolute;margin-top:3px;padding:4px;width:120px;border:solid #DDD;border-width:0 1px 1px}.ie6 .pmfrndl,.ie7 .pmfrndl{margin-top:4px;}.pmfrndl li{display:inline;}.pmfrndl a{display:block;padding:4px 2px;color:#59cbc7;}.pmfrndl a:hover{text-decoration:none;}.pmfrndl a.a{background:#E5EDF2;}#showSelectBox_menu{padding:10px;width:300px;white-space:nowrap;}#selBox{margin:0 -10px 10px;padding-left:10px;height:110px;border:solid #DFDFDF;border-width:1px 0;overflow-y:auto;}.unfold,.fold{float:right;padding-left:10px;background:url(.static/image/common/arrwd.gif) no-repeat 0 50%;cursor:pointer;outline:none;}
