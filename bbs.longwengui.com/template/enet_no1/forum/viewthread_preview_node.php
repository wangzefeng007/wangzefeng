...
<dl class="bbda cl" style="padding-left:73px">
	<!--{if empty($post['deleted'])}-->
		<!--{if $post[author] && !$post['anonymous']}-->
		<dd class="avt" style="float:left;margin-left:-73px"><a href="home.php?mod=space&uid=$post[authorid]"><!--{avatar($post[authorid], small)}--></a></dd>
		<!--{else}-->
		<dd class="avt" style="float:left;margin-left:-73px"><img src="{STATICURL}image/magic/hidden.gif" alt="hidden" /></dd>
		<!--{/if}-->
