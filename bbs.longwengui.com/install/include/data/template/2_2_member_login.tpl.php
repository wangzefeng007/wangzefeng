...
0
|| checktplrefresh('./template/enet_no1/member/login.htm', './template/enet_no1/common/seccheck.htm', 1496375028, '2', './data/template/2_2_member_login.tpl.php', './template/enet_no1', 'member/login')
...
<tr>
<th>安全提问:</th>
<td><select id="loginquestionid_<?php echo $loginhash;?>" size="1" name="questionid"<?php if(!$questionexist) { ?> onchange="if($('loginquestionid_<?php echo $loginhash;?>').value > 0) {$('loginanswer_row_<?php echo $loginhash;?>').style.display='';} else {$('loginanswer_row_<?php echo $loginhash;?>').style.display='none';}"<?php } ?>>
...
<td style="padding-left:100px;"><a href="javascript:;" onclick="display('layer_login_<?php echo $loginhash;?>');display('layer_lostpw_<?php echo $loginhash;?>');" title="找回密码" style="line-height: 29px;">找回密码</a></td>
</tr>
</table>
</div>
...
<th>&nbsp;</th>
<td style="width:75px">
<button class="pn pnc" type="submit" name="loginsubmit" value="true" tabindex="1" style="width:68px"><strong>登录</strong></button>
</td>
<td>
<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="pn rig" style="width: 130px;height: 25px !Important;display:block"><strong style="line-height:26px"><?php echo $_G['setting']['reglinkname'];?></strong></a></td>
<td>
...
<tr>
<th></th>
<td><button class="pn pnc" type="submit" name="lostpwsubmit" value="true" tabindex="100" style="width: 234px;"><span>提交</span></button></td>
</tr>
</table>
</div>
</div>
