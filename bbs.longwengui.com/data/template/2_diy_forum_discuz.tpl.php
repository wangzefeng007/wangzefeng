...
<div class="bm">
<div class="bm_h cl">
<h2 class="xs2"><?php echo $_G['setting']['navs']['2']['navname'];?>热点</h2>
</div>
<div class="bm_c cl">
...
<?php if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = $forumscount > 3 ? ($forumscount == 4 ? 4 : 5) : 1;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="<?php if($forumcolumns) { ?>flg <?php } ?>cl list">
<div class="bm_h cl">
<span class="o">
...
<tr><?php $favorderid = 0;?><?php $i = 1;?><?php if(is_array($forum_favlist)) foreach($forum_favlist as $key => $favorite) { if($favforumlist[$favorite['id']]) { $forum=$favforumlist[$favorite[id]];?><?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?><?php if($forumcolumns>1) { if($favorderid && ($favorderid % $forumcolumns == 0)) { ?>
</tr>
...
<dt><a href="<?php echo $forumurl;?>" class="bbstil xi2"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1 jinri" title="今日"><?php echo $forum['todayposts'];?></em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd class="xg1"><em><span class="t">主题:</span><?php echo dnumber($forum['threads']); ?></em><em><span style="margin-left:4px" class="t">帖数:</span><?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd class="xg1">			
...
<?php } elseif(is_array($forum['lastpost'])) { ?><a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost"><?php echo $forum['lastpost']['dateline'];?></a>
<?php } else { ?>从未<?php } ?>						
</em>							
<?php } ?>					
</dd>
...
<?php echo $forum['icon'];?>
<?php } else { ?>
<a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo $_G['style']['styleimgdir'];?>/0<?php echo $i;?>.png" alt="<?php echo $forum['name'];?>" /><?php $i >= 9 ? $i = 1 : $i++;?></a>
<?php } ?>
</td>
<td>
<h2><a href="<?php echo $forumurl;?>" class="bbstil xi2"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1 jinri" title="今日"><?php echo $forum['todayposts'];?></em><?php } ?></h2>
<?php if($forum['description']) { ?><p class="xg2" style="margin-top:2px"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p style="margin-top:3px">子版块: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p style="margin-top:3px">版主: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
</div><?php echo adshow("intercat/bm a_c/-1");?><?php } if(!empty($collectiondata['follows'])) { $forumscount = count($collectiondata['follows']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="<?php if($forumcolumns) { ?>flg <?php } ?>cl list">
<div class="bm_h cl">
<span class="o">
...
<h2><a href="forum.php?mod=collection&amp;op=my" class="xs2">我订阅的专辑</a></h2>
</div>
<div id="category_-1" class="bm_c" style="<?php echo $collapse['category_-1']; ?>">
<table cellspacing="0" cellpadding="0" class="fl_tb">
<tr><?php $ctorderid = 0;?><?php $i = 1;?><?php if(is_array($collectiondata['follows'])) foreach($collectiondata['follows'] as $key => $colletion) { if($ctorderid && ($ctorderid % $forumcolumns == 0)) { ?>
</tr>
...
<td class="fl_g"<?php if($forumcolwidth) { ?> width="<?php echo $forumcolwidth;?>"<?php } ?>>
<div class="fl_icn_g">
<a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/0<?php echo $i;?>.png" alt="<?php echo $forum['name'];?>" /></a><?php $i >= 9 ? $i = 1 : $i++;?></a>
</div>
<dl>
<dt><a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>" class="bbstil xi2"><?php echo $colletion['name'];?></a></dt>
<dd class="xg1"><em><span class="t">主题:</span><?php echo dnumber($forum['threads']); ?></em><em><span style="margin-left:4px" class="t">帖数:</span><?php echo dnumber($forum['posts']); ?></em></dd>
<dd class="xg1">
<span class="t">最新:</span>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $colletion['lastpost'];?>&amp;goto=lastpost#lastpost"><?php echo dgmdate($colletion[lastposttime]);?></a>
<?php } } else { ?>
从未
<?php } ?>
</dd>
...
<div class="<?php if($cat['forumcolumns']) { ?>flg <?php } ?>cl list">
<div class="bm_h cl">
<span class="o">
...
<?php if($cat['moderators']) { ?><span class="y">分区版主: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>" class="xs2"><?php echo $cat['name'];?></a></h2>
</div>
...
<?php echo $forum['icon'];?>
<?php } else { ?>
<a href="<?php echo $forumurl;?>" class="bbstil xi2"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo $_G['style']['styleimgdir'];?>/0<?php echo $i;?>.png" alt="<?php echo $forum['name'];?>" /></a><?php $i >= 9 ? $i = 1 : $i++;?><?php } ?>
</div>
<dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
<dt><a href="<?php echo $forumurl;?>" class="bbstil xi2"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1 jinri" title="今日"><?php echo $forum['todayposts'];?></em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd class="xg1"><em><span class="t">主题:</span><?php echo dnumber($forum['threads']); ?></em><em><span style="margin-left:4px" class="t">帖数:</span><?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
...
</div><?php echo adshow("intercat/bm a_c/$cat[fid]");?><?php } if(!empty($collectiondata['data'])) { $forumscount = count($collectiondata['data']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="<?php if($forumcolumns) { ?>flg <?php } ?>cl list">
<div class="bm_h cl">
<span class="o">
...
<h2><a href="forum.php?mod=collection" class="xs2">淘专辑推荐</a></h2>
</div>
<div id="category_-2" class="bm_c" style="<?php echo $collapse['category_-2']; ?>">
<table cellspacing="0" cellpadding="0" class="fl_tb">
<tr><?php $ctorderid = 0;?><?php $i = 1;?><?php if(is_array($collectiondata['data'])) foreach($collectiondata['data'] as $key => $colletion) { if($ctorderid && ($ctorderid % $forumcolumns == 0)) { ?>
</tr>
<?php if($ctorderid < $forumscount) { ?>
<tr class="fl_row">
<?php } } ?>
<td class="fl_g"<?php if($forumcolwidth) { ?> width="<?php echo $forumcolwidth;?>"<?php } ?>>
<div class="fl_icn_g">
<a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/0<?php echo $i;?>.png" alt="<?php echo $forum['name'];?>" /></a><?php $i >= 9 ? $i = 1 : $i++;?></div>
<dl>
<dt><a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $colletion['ctid'];?>" class="bbstil xi2"><?php echo $colletion['name'];?></a></dt>
...
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="收起/展开"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="收起/展开" style="margin-top:9px" /></a></span>
<h3>
...
<span class="o"><a href="forum.php?showoldetails=yes#online" title="收起/展开"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="收起/展开" style="margin-top:9px" /></a></span>
<?php } ?>
<h3>
<strong>
