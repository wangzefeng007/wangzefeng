...
0
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/forumdisplay_leftside.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/recommend.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/common/seccheck.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/forumdisplay_list.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/forumdisplay_sort.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/search_sortoption.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
|| checktplrefresh('./template/enet_no1/forum/forumdisplay.htm', './template/enet_no1/forum/search_sortoption.htm', 1496303377, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/enet_no1', 'forum/forumdisplay')
...
<?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?><span class="o y"><img id="forum_rules_<?php echo $_G['fid'];?>_img" src="<?php echo IMGDIR;?>/collapsed_<?php echo $collapse['forum_rulesimg'];?>.gif" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('forum_rules_<?php echo $_G['fid'];?>')"/></span><?php } ?>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" class="forumtitle" style="text-decoration: none;float: left;margin-right: 10px;font-size:45px;line-height:55px"><?php echo $_G['forum']['name'];?></a>
...
<span class="pipe"></span><strong style="padding-left:10px">
...
<?php if(!$subforumonly) { ?><div class="xs1 xw0 i"><div style="float:left">今日: <strong class="xi1"><?php echo $_G['forum']['todayposts'];?></strong><?php if($_G['forum']['todayposts']) { if($_G['forum']['todayposts'] < $_G['forum']['yesterdayposts']) { ?><b class="ico_fall">&nbsp;</b><?php } else { ?><b class="ico_increase">&nbsp;</b><?php } } ?><span class="pipe"></span>主题: <strong class="xi1"><?php echo $_G['forum']['threads'];?></strong><?php if($_G['forum']['rank']) { ?><span class="pipe"></span>排名: <strong class="xi1" title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></strong><?php if($_G['forum']['rank'] <= $_G['forum']['oldrank']) { ?><b class="ico_increase">&nbsp;</b><?php } else { ?><b class="ico_fall">&nbsp;</b><?php } } ?></div><?php if($moderatedby) { ?><div style="float:right;font-size: 14px">版主: <span class="xg1"><?php echo $moderatedby;?></span></div><?php } ?></div><?php } ?>
...
<div class="bm_c bm_h cl pbn" id="forum_rules_<?php echo $_G['fid'];?>" style="height:auto;margin-bottom:0;padding:0 10px !Important;<?php echo $collapse['forum_rules'];?>;">
...
<div id="forum_rules_<?php echo $_G['fid'];?>">
<div class="ptn xg2" style="white-space: normal;padding-top:5px !Important"><?php echo $_G['forum']['rules'];?></div>
</div>
<?php } ?>
</div>
...
<?php } ?>
<div id="pgt" class="bm bw0 pgs cl" style="padding:10px 12px;margin-bottom: 0px;padding-bottom: 6px;padding-top: 15px">
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><img src="template/enet_no1/images/pn_post.png" alt="发新帖" /></a><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_postbutton_top'])) echo $_G['setting']['pluginhooks']['forumdisplay_postbutton_top'];?>
</div>
</div>
</div>
</div>
<div id="ct" class="wp cl<?php if($_G['forum']['allowside']) { ?> ct4<?php } ?>" <?php if($leftside) { ?> style="margin-left:<?php echo $_G['leftsidewidth_mwidth'];?>px"<?php } ?>>
<?php if($leftside) { ?>
...
<div class="bm bmw fl<?php if($_G['forum']['forumcolumns']) { ?> flg<?php } ?>" style="border-top:1px solid #dfdfdf">
<div class="bm_h cl">
...
<?php } } ?>
<td class="fl_g">
<div class="fl_icn_g" style="width:31px !Important">
...
<dl style="margin-left:31px !Important">
...
<?php } ?>
<td class="num" style="width:120px"><span style="float:right;line-height:15px" id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="y atarget_1"<?php } else { ?>onclick="setatarget(1)" class="y"<?php } ?> title="在新窗口中打开帖子">新窗</span></td>
<?php } else { ?>
<th class="by" colspan="3">
...
<td class="avt">
<a><img src="<?php echo IMGDIR;?>/annpm.png" alt="公告" /></a>
</td>
...
<p class="mtn xg1">作者:<a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>"><?php echo $announcement['author'];?></a>&nbsp;&nbsp;发布时间:<?php echo $announcement['starttime'];?></p>
</th>
<td class="flt">
</td>
<td class="flt">
...
<tbody id="separatorline" class="emptb"><tr><td class="avt"></td><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o"></td><?php } ?><th class="common" style="padding-bottom:0 !Important"></th><td class="flt"></td><td class="flt"></td><td class="by"></td></tr></tbody>
...
<td class="by">
<div class="xld" style="float: right"><span class="m hm"><strong class="xi2"><?php echo $thread['allreplies'];?></strong><span>回复</span></span><span class="m hm"><strong class="xi2"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></strong><span>查看</span></span></div>
</td>
</tr>
</tbody>
<?php } ?>
...
<ul id="waterfall" class="ml waterfall cl" style="margin: 10px auto;"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if($_G['hiddenexists'] && $thread['hidden']) { continue;?><?php } if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { $thread[tid]=$thread[closed];?><?php } } $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?><li style="width:<?php echo $waterfallwidth;?>px">
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
...
<h3 class="xw0" style="font-size: 14px">
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?>
...
<div class="auth cl">
<cite class="xg1" style="padding-top: 10px">
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?>
<?php if($thread['authorid'] && $thread['author']) { if($thread['authorid'] && $thread['author']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="picavt"><?php echo avatar($thread[authorid],small);?></a>
<?php } else { ?><a class="picavt"><img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.gif" title="<?php echo $_G['setting']['anonymoustext'];?>" alt="<?php echo $_G['setting']['anonymoustext'];?>" width="30" height="30" /></a><?php } ?><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="xg1" style="float:left;margin-top:7px;margin-left: 5px;width:80%"><?php echo $thread['author'];?></a><span class="date_pic" style="width:80%;float:left;margin-left:5px"><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span></span><?php if(!empty($verify[$thread['authorid']])) { ?> <a style="float:left;margin-top: 13px;margin-left: 5px"><?php echo $verify[$thread['authorid']];?></a><?php } } else { ?>
...
<?php if($detailstatus) { ?>
<div class="bm_h cl">
<span class="o y" style="width:17px"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;page=<?php echo $page;?>&amp;showoldetails=no#online"><img src="<?php echo IMGDIR;?>/collapsed_no_1.gif" alt="" /></a></span>
<h2 style="font-size:12px">正在浏览此版块的会员 (<?php echo $onlinenum;?>)</h2>
</div>
<div class="bm_c">
...
<?php } else { ?>
<div class="bm_h cl">
<span class="o y" style="width:17px"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;page=<?php echo $page;?>&amp;showoldetails=yes#online" class="nobdr"><img src="<?php echo IMGDIR;?>/collapsed_yes_1.gif" alt="" /></a></span>
<h2 style="font-size:12px">正在浏览此版块的会员 (<?php echo $onlinenum;?>)</h2>
</div>
<?php } ?>
</div>
