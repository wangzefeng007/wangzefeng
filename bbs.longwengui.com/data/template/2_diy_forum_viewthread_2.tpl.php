...
0
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/forum/viewthread_node.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/forum/viewthread_fastpost.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/forum/viewthread_node_body.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/common/seditor.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/forum/seccheck_post.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/default/common/upload.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/enet_no1//forum/viewthread_2.htm', './template/enet_no1/common/seccheck.htm', 1496304109, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/enet_no1/', 'forum/viewthread_2')
...
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="tabspOX1H" class="frame-tab move-span cl"><div id="tabspOX1H_title" class="tab-title title column cl" switchtype="click"><span class="titletext">tab标签</span></div><div id="tabspOX1H_content" class="tb-c"></div><script type="text/javascript">initTab("tabspOX1H","click");</script></div></div><!--[/diy]-->
...
<div id="postlist" class="pl bf bm" style="margin-bottom:0px;border-width:1px;border-radius: 5px 5px 0 0 !important">
<table cellspacing="0" cellpadding="0">
<tr>
<td class="plc pbn vwthd" style="border: 0 !important;padding-top:11px;padding-right:20px !important;padding-bottom:10px !Important">
<?php if($_G['forum_thread']['authorid'] && $_G['forum_thread']['author']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="topavt"><?php echo avatar($_G[forum_thread][authorid],middle);?></a>
<?php } else { ?>
<a class="topavt"><img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.gif" title="<?php echo $_G['setting']['anonymoustext'];?>" alt="<?php echo $_G['setting']['anonymoustext'];?>" /></a>
<?php } if(!IS_ROBOT) { ?>
<div class="y" style="margin-top:5px;margin-right:-2px !important">
...
<?php } ?>
<h1 class="ts" style="font-size:20px">
...
<?php } ?>
<span id="thread_subject" style="font-weight:100"><?php echo $_G['forum_thread']['subject'];?></span>
</h1>
<span class="xg1">
...
<div>
<div class="mtn xg1" style="font-size: 12px;margin-bottom:2px;float:left">
...
<div style="float:left"><span>版块:</span></div>
  <div style="float:left;overflow: hidden;width:500px"><span style="margin-left:-5px"><?php echo $navigation;?></span>
<span>发布时间:</span><span id="authorposton<?php echo $post['pid'];?>"><?php echo $post['dateline'];?></span>
  </div>
</div>
<div class="hm ptn" style="margin-top: 0px;padding-top: 3px !important;text-align: right;">
<span class="show xi1" title="查看"><?php echo $_G['forum_thread']['views'];?></span><span class="pipe"></span><span class="reply xi1" title="回复"><?php echo $_G['forum_thread']['allreplies'];?></span>
</div>
</td>
</div>
</tr>
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><img src="template/enet_no1/images/pn_post.png" alt="发新帖" /></a><?php } } ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><img src="template/enet_no1/images//pn_reply.png" alt="回复" /></a>
...
<div id="postlist" class="pl" style="margin-top:10px">
...
<?php echo $_G['forum_thread']['replycredit'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>
<?php if(!$close_leftinfo) { ?>
</td>
...
<div id="pid<?php echo $post['pid'];?>" class="bm" style="border:0"><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<div class="bm <?php if(!IS_ROBOT && $post['first']) { ?>first_post<?php } ?>" style="margin-bottom:10px;background:transparent">
<table class="plhin" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
<tr>
<?php if(0) { } ?>	
<td class="plc" style="padding: 0 20px<?php if($close_leftinfo) { ?>;width:100%<?php } ?>">
<div class="avt_left pls favatar" style="margin-top:15px;float:left;padding-bottom: 10px;width:90px;<?php if(!IS_ROBOT && $post['first']) { ?>display:none<?php } ?>">
<?php if($post['authorid'] && $post['username'] && !$post['anonymous']) { ?>
<div class="blk bui" id="userinfo<?php echo $post['pid'];?>" style="display: none;margin-top:-16px !important;margin-left: -21px !important;">
<div class="z">
<div id="userinfo<?php echo $post['pid'];?>_ma" class="avts"></div>
...
<div class="i y">
<div>
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" style="font-size: 15px"><?php echo $post['author'];?></a>
...
<?php if($post['medals']) { ?>
<p class="md_ctrl">
<a href="home.php?mod=medal"><?php if(is_array($post['medals'])) foreach($post['medals'] as $medal) { ?><img id="md_<?php echo $post['pid'];?>_<?php echo $medal['medalid'];?>" src="<?php echo STATICURL;?>image/common/<?php echo $medal['image'];?>" alt="<?php echo $medal['name'];?>" title="" />
<?php } ?>
</a>
</p>
<?php } ?>
...
<?php } ?>
<div style="width: 90px;height: 90px;margin-bottom:5px"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" onmouseover="showauthor(this, 'userinfo<?php echo $post['pid'];?>')" class="xi2 avts z" style="margin-right:15px"><?php echo avatar($post['authorid'], 'middle'); ?></a></div>
...
<div>
<div class="pi" style="border:0px !important;padding-bottom:3px;overflow: visible;padding-top:15px;margin-left:105px;<?php if(!IS_ROBOT && $post['first']) { ?>margin-left:0<?php } ?>">
<?php if(!IS_ROBOT) { ?>
<strong>
...
<div class="authi">
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2" style="font-size:15px;padding-right:5px;<?php if(!IS_ROBOT && $post['first']) { ?>display:none<?php } ?>"><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($_self ) { ?>
...
<?php } ?>
<em id="authorposton<?php echo $post['pid'];?>" <?php if(!IS_ROBOT && $post['first']) { ?>style="display:none"<?php } ?>>发表于 <?php echo $post['dateline'];?></em>
<?php if($post['status'] & 8) { ?>
<span><?php if($_G['setting']['mobile']['mobilecomefrom']) { ?><?php echo $_G['setting']['mobile']['mobilecomefrom'];?><?php } else { ?>来自手机<?php } ?></span>
...
</div><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct" style="margin-left:105px;<?php if(!IS_ROBOT && $post['first']) { ?>margin-left:0<?php } ?>"><?php echo adshow("thread/a_pt/2/$postcount");?><?php if(empty($ad_a_pr_css)) { ?>
...
<ul class="xl xl2 cl"><?php if(is_array($post['relatecollection'])) foreach($post['relatecollection'] as $var) { ?><li>&middot; <a href="forum.php?mod=collection&amp;action=view&amp;ctid=<?php echo $var['ctid'];?>" title="<?php echo $var['name'];?>" target="_blank" class="xi2 xw1"><?php echo $var['name'];?></a><span class="pipe">|</span><span class="xg1">主题: <?php echo $var['threadnum'];?>, 订阅: <?php echo $var['follownum'];?></span></li>
...
<tr><td class="plc plm" style="padding:0 20px">
...
<div id="p_btn" class="hm cl" style="margin:0">
...
<?php } ?>
<td class="plc" style="padding:0 20px;overflow:visible">
<div style="border-top:1px dotted #dfdfdf">
<?php if(!$post['first'] && $modmenu['post']) { ?>
<span class="y" style="line-height: 36px">
...
<div id="comment_<?php echo $post['pid'];?>" style="position:relative"><?php if($_G['setting']['commentnumber'] && !empty($comments[$post['pid']])) { ?><span class="icon_preview" style="top: -6px;left: 27px;z-index:2"></span><div class="cmtl xld" style="padding-left: 22px;margin-bottom: 10px;border: 1px solid #C2D5E3;border-radius: 5px;padding-top: 5px;padding-bottom: 5px;position:relative">
...
<dd class="m"><a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" class="avt"><?php echo $comment['avatar'];?></a></dd>
...
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><div class="pgbtn" style="width:100% !important;position: relative;z-index: 0;margin-left:0"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="bm_h" style="background:#f5f5f5">下一页 &raquo;</a></div>
<?php } ?>
<div class="bm" style="padding: 20px 0 10px 0">
<?php if($modmenu['thread']) { ?>
<div id="modmenu" class="xg1 mbm" style="padding:0 20px">
...
<div class="pgs cl" style="padding:0 20px;margin-bottom:10px">
<?php echo $multipage;?>
...
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><img src="template/enet_no1/images/pn_post.png" alt="发新帖" /></a>
<?php } ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><img src="template/enet_no1/images//pn_reply.png" alt="回复" /></a>
</div>
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bm bmw<?php } ?>" style="border:0">
...
<tr>
<td class="plc">
<div style="border-radius:5px;padding:0 20px">
<?php } ?>
...
<div id="file"><?php echo $seditor['3'];?></div>
</div></div>
<div class="area">
