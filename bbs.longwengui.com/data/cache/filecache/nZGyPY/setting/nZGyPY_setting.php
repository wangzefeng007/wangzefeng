...
{time}',
    ...
    'transferstatus' => true,
    'ucenterurl' => 'http://bbs.longwengui.net/uc_server',
    'tradeopen' => 1,
    'medalstatus' => 0,
    'specialicon' => 
    array (
    ...
    array (
      ...
      array (
        'available' => '1',
        'navname' => '道具',
        'code' => '<a href="home.php?mod=magic" style="background-image:url(http://bbs.longwengui.net/static/image/feed/magic_b.png) !important">道具</a>',
        'level' => '0',
      ),
      'medal' => 
      array (
        'available' => '1',
        'navname' => '勋章',
        'code' => '<a href="home.php?mod=medal" style="background-image:url(http://bbs.longwengui.net/static/image/feed/medal_b.png) !important">勋章</a>',
        'level' => '0',
      ),
      'task' => 
      array (
        'available' => '1',
        'navname' => '任务',
        'code' => '<a href="home.php?mod=task" style="background-image:url(http://bbs.longwengui.net/static/image/feed/task_b.png) !important">任务</a>',
        'level' => '0',
      ),
      'friend' => 
      array (
        'available' => '0',
        'navname' => '好友',
        'code' => '<a href="home.php?mod=space&do=friend" style="background-image:url(http://bbs.longwengui.net/static/image/feed/friend_b.png) !important">好友</a>',
        'level' => '0',
      ),
      'thread' => 
      array (
        'available' => '0',
        'navname' => '帖子',
        'code' => '<a href="forum.php?mod=guide&view=my" style="background-image:url(http://bbs.longwengui.net/static/image/feed/thread_b.png) !important">帖子</a>',
        'level' => '0',
      ),
      'favorite' => 
      array (
        'available' => '0',
        'navname' => '收藏',
        'code' => '<a href="home.php?mod=space&do=favorite&view=me" style="background-image:url(http://bbs.longwengui.net/static/image/feed/favorite_b.png) !important">收藏</a>',
        'level' => '0',
      ),
    ),
    'topnavs' => 
    array (
      ...
      array (
        ...
        array (
          'available' => '1',
          'navname' => '设为首页',
          'code' => '<a href="javascript:;"  onclick="setHomepage(\'http://bbs.longwengui.net/\');">设为首页</a>',
          'type' => '0',
          'level' => '0',
          'id' => 'sethomepage',
        ),
        ...
        array (
          'available' => '1',
          'navname' => '收藏本站',
          'code' => '<a href="http://bbs.longwengui.net/"  onclick="addFavorite(this.href, \'Discuz! Board\');return false;">收藏本站</a>',
          'type' => '0',
          'level' => '0',
          'id' => 'setfavorite',
        ),
...
{Y7DDddDY}
<dl class="pil cl">
	<dt>{xleJaK11}</dt><dd>{da9tsjhs}</dd>
</dl>
{CFOFQaR3}
<dl class="pil cl">{xy0mmgJ1}</dl>',
          'top' => '<dl class="cl">
<dt>{y3uf6Gfe}</dt><dd>{V87Q4ck0}</dd>
</dl>',
        ),
      ),
      'code' => 
    ...
    'uchomeurl' => '',
    'discuzurl' => 'http://bbs.longwengui.net',
    'homeshow' => '0',
    'csspathv' => 'data/cache/',
