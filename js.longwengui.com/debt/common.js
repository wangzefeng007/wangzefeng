...
function openProtocalWindow(){
    var index = layer.open({
        ...
        +                '<p>2.2 服务形式</p>'
        +                '<p>2.2.1您可通过隆文贵网站（www.longwengui.com或www.longcheng513.com）、隆文贵移动客户端、隆文贵微信公众号等方式获取服务。对于这些服务，隆文贵给予您一项个人的、不可转让及非排他性的许可。您仅可为访问和使用本服务的目的使用这些软件及服务。本条及本协议其他条款未明示授权的其他一切权利仍由隆文贵保留。</p>'
        +                '<p>2.2.2本服务中隆文贵客户端软件提供包括但不限于iOS、Android等多个应用版本，用户必须选择与所安装终端设备相匹配的软件版本。</p>'
        +                '<p>三、软件的获取、安装与卸载</p>'
        +                '<p>3.1 您可以直接从隆文贵网站（www.longwengui.com或www.longcheng513.com）获取本软件，也可从隆文贵授权的第三方平台获取。如果您从未经隆文贵授权的第三方获取本软件或与本软件名称相同的安装程序，隆文贵无法保证该软件能正常使用，并对因此给您造成的损失不负责任。</p>'
